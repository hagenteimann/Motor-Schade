...
- Local: Chrome DevTools, Firefox Developer, Safari Inspector
- Cross-browser check: https://caniuse.com/
...
- Local Device Testing (iPhone, Android)
...
**Wenn Fehler:**
→ Detaillierte Fehlerbeschreibung dokumentieren
→ Fix vor Deploy
→ Re-test
